        ...
        <table class="w-full text-left">
          ...
          <tbody>
            <tr v-if="loadingUsuarios" class="border-b border-slate-50">
              <td colspan="6" class="p-10 text-center text-slate-400 italic">Cargando usuarios...</td>
            </tr>
            <tr v-else-if="usuarios.length === 0" class="border-b border-slate-50">
              <td colspan="6" class="p-10 text-center text-slate-400 italic">No se encontraron usuarios.</td>
            </tr>
            ...
            <table v-else class="w-full text-left bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              <tbody>
                <tr v-for="(permiso, index) in permisosForm" :key="permiso.modulo_id" class="border-b border-slate-100 hover:bg-slate-50">
                  <td class="p-4 font-bold text-slate-700">{{ permiso.modulo_nombre }}</td>
                  ...
                  <td class="p-4 text-center">
                    <input type="checkbox" v-model="permiso.puedeVer" :true-value="1" :false-value="0" class="w-5 h-5 text-purple-600 rounded focus:ring-purple-500 cursor-pointer">
                  </td>
                  <td class="p-4 text-center">
                    <input type="checkbox" v-model="permiso.puedeCrear" :true-value="1" :false-value="0" class="w-5 h-5 text-purple-600 rounded focus:ring-purple-500 cursor-pointer">
                  </td>
                  <td class="p-4 text-center">
                    <input type="checkbox" v-model="permiso.puedeEditar" :true-value="1" :false-value="0" class="w-5 h-5 text-purple-600 rounded focus:ring-purple-500 cursor-pointer">
                  </td>
                  <td class="p-4 text-center">
                    <input type="checkbox" v-model="permiso.puedeEliminar" :true-value="1" :false-value="0" class="w-5 h-5 text-purple-600 rounded focus:ring-purple-500 cursor-pointer">
                  </td>
                </tr>
              </tbody>
            </table>
